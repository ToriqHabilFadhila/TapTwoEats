        ...
        <div class="tte-footer-main tte-footer-inner-wrap">
            ...
            <div class="tte-footer-grid">
                ...
                <div class="tte-footer-brand">
                    <a href="{{ route('home') }}" class="tte-footer-logo">
                        <div class="tte-footer-logo-icon">
                            <img src="{{ asset('images/TapTwoEats.png') }}" alt="TapTwoEats Logo" width="100" height="100" style="object-fit:contain;">
                        </div>
                    ...
                    <p class="tte-footer-desc">
                        Delivering joy, one meal at a time. Order from hundreds of restaurants in Malang and get it delivered hot & fresh to your door.
                    </p>
                    {{-- Socials --}}
                    <div>
                        <p style="font-family:'Bricolage Grotesque',sans-serif; font-size:0.74rem; font-weight:700; letter-spacing:.06em; text-transform:uppercase; color:#9aa5c0; margin:0 0 8px;">Follow Us</p>
                ...
                <div>
                    ...
                    <ul class="tte-footer-links">
                        @foreach([
                            ['Home',          route('home')],
                            ['All Menu',      route('menu.all')],
                            ['Popular Dishes',route('menu.popular')],
                            ['New Arrivals',  route('menu.new')],
                            ['Special Deals', route('menu.deals')],
            ...
            <div style="display:flex; gap:1px; margin-bottom:2.5rem; background:rgba(79,126,247,0.1); border-radius:16px; overflow:hidden;">
                <div style="flex:1; background:rgba(255,255,255,0.55); backdrop-filter:blur(12px); padding:1.1rem 1.2rem; text-align:center;">
                    <div style="font-size:1.5rem; font-weight:800; background:linear-gradient(135deg,#4F7EF7,#22D3EE); -webkit-background-clip:text; background-clip:text; color:transparent; line-height:1;">1,000+</div>
                    <div style="font-size:0.76rem; font-weight:600; color:#9aa5c0; margin-top:3px; font-family:'Bricolage Grotesque',sans-serif;">Restaurants</div>
                </div>
                <div style="flex:1; background:rgba(255,255,255,0.55); backdrop-filter:blur(12px); padding:1.1rem 1.2rem; text-align:center;">
                    <div style="font-size:1.5rem; font-weight:800; background:linear-gradient(135deg,#22D3EE,#0891b2); -webkit-background-clip:text; background-clip:text; color:transparent; line-height:1;">50K+</div>
                    <div style="font-size:0.76rem; font-weight:600; color:#9aa5c0; margin-top:3px; font-family:'Bricolage Grotesque',sans-serif;">Happy Customers</div>
                </div>
                <div style="flex:1;background:rgba(255,255,255,0.55);backdrop-filter:blur(12px);padding:1.1rem 1.2rem;text-align:center;">
                    <div style="font-size:1.5rem; font-weight:800; background:linear-gradient(135deg,#fb923c,#f97316); -webkit-background-clip:text; background-clip:text; color:transparent; line-height:1;">100K+</div>
                    <div style="font-size:0.76rem; font-weight:600; color:#9aa5c0; margin-top:3px; font-family:'Bricolage Grotesque',sans-serif;">Deliveries Done</div>
                </div>
                <div style="flex:1;background:rgba(255,255,255,0.55);backdrop-filter:blur(12px);padding:1.1rem 1.2rem;text-align:center;">
                    <div style="font-size:1.5rem; font-weight:800; background:linear-gradient(135deg,#a78bfa,#7c3aed); -webkit-background-clip:text; background-clip:text; color:transparent; line-height:1;">4.9 ⭐</div>
                    <div style="font-size:0.76rem; font-weight:600; color:#9aa5c0; margin-top:3px; font-family:'Bricolage Grotesque',sans-serif;">Average Rating</div>
                </div>
            </div>
            {{-- ── Divider ── --}}
            ...
            <div class="tte-footer-bottom">
                ...
                <div class="tte-payment-row">
                    ...
                    @foreach([
                        ...
                        ['BCA',        'BCA.svg',        'background:#005BAC; border-color:#005BAC;'],
                        ['GoPay',      'GOPAY.png'],
                        ['OVO',        'OVO.png'],
                        ['DANA',       'DANA.png'],
                    ] as [$name, $file])
